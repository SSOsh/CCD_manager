...
@WebServlet("/DeleteMember") //연동할 jsp 혹은 컨트롤러 명을 명시해주면 된다.
public class DeleteMember extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException
    {
        ...
        dao.deleteMemberInfo(req.getParameter("selected")); //삭제 실행

        memberList = dao.lookupMemberList(); //삭제 후 전체 리스트 출력해주기 위해 담아옴
